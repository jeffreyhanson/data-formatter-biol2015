Vegetation_Assessment=DATA_PREP$new(
	...
	format=function(inpDF) {
		...
		inpDF[,`Spider Hole`:=first.not.na(`Spider Hole`),by=list(`Group`, `Quadrat size`, `Vegetation type`)]
	...
	errors=list(
		...
		ERROR_TEMPLATE.TRUNCATED('Shrub count'),
		ERROR_TEMPLATE.OUTLIER('Shrub count'),
		ERROR_TEMPLATE.TRUNCATED('Spider Hole'),
		ERROR_TEMPLATE.OUTLIER('Spider Hole'),
